...
import ResultSettings, {FontValues, ResultSettingsValuesProps} from './components/ResultSettings';
import './App.css';
...
const initialValues: FormSettingsValuesProps & ResultSettingsValuesProps = {
    sites: "",
    textColor: { hex: "#222222", hsl: { a: 100, h: 0, s: 0, l: 13 }, rgb: { r: 34, g: 34, b: 34} },
    linkColor: { hex: "#00278e", hsl: { a: 100, h: 224, s: 100, l: 28 }, rgb: { r: 0, g: 39, b: 142 } },
    urlColor: { hex: "#20692b", hsl: { a: 100, h: 129, s: 53, l: 27}, rgb: { r: 32, g: 105, b: 43 } },
    headerColor: { hex: "#fafafa", hsl: { a: 100, h: 0, s: 0, l: 98 }, rgb: { r: 250, g: 250, b: 250 } },
    backgroundColor: { hex: "#ffffff", hsl: { a: 100, h: 0, s: 0, l: 100 }, rgb: { r: 255, g: 255, b: 255 } },
    textFont: "p",
    buttonText: "Search",
...
const App: React.FC = () => {
    ...
    const [textColor, setTextColor] = useState<ColorResult>(initialValues.textColor);
    const [linkColor, setLinkColor] = useState<ColorResult>(initialValues.linkColor);
    const [urlColor, setUrlColor] = useState<ColorResult>(initialValues.urlColor);
    const [headerColor, setHeaderColor] = useState<ColorResult>(initialValues.headerColor);
    const [backgroundColor, setBackgroundColor] = useState<ColorResult>(initialValues.backgroundColor);
    ...
    const [placeholderText, setPlaceholderText] = useState(initialValues.placeholderText);
    const [showSearchButton, setShowSearchButton] = useState(initialValues.showSearchButton);
